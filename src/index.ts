...
async function uploadFileToStorageContainer(containerSasURL: string) {
    ...
    const blobServiceClient = BlobServiceClient.fromConnectionString(azureAccountConfig.StorageConnection)
...
function processFile(fileName: string) {
    //authenticating
    msRestNodeAuth
        .loginWithServicePrincipalSecretWithAuthResponse(azureAccountConfig.AadClientId, azureAccountConfig.AadSecret, azureAccountConfig.AadTenantId)
