...
DROP FUNCTION IF EXISTS get_all_video_data_by_limit;

CREATE FUNCTION get_all_video_data_by_limit(limit_amount INT)
...
BEGIN
    ...
    WHERE public.video.streaming_url IS NOT NULL LIMIT limit_amount;
END; $$;

-- SELECT * FROM get_all_video_data_by_limit(2);